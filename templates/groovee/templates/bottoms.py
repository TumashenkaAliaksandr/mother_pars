...
with open('../done_csv/groovee_bottoms.csv', 'w', newline='', encoding='utf-8') as csvfile:
...
with open('../urls_csv/urls_bottoms.csv', 'r', newline='', encoding='utf-8') as csvfile:
    ...
    for row in reader:
        ...
        with open('../done_csv/groovee_bottoms.csv', 'a', newline='', encoding='utf-8') as csvfile:
            writer = csv.writer(csvfile)
