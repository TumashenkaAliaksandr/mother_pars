...
with open('../done_csv/groovee_womens.csv', 'w', newline='', encoding='utf-8') as csvfile:
...
with open('../urls_csv/urls_womens.csv', 'r', newline='', encoding='utf-8') as csvfile:
    ...
    for row in reader:
        ...
        with open('../done_csv/groovee_womens.csv', 'a', newline='', encoding='utf-8') as csvfile:
            writer = csv.writer(csvfile)
