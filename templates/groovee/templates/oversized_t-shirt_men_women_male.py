...
with open('../done_csv/groovee_oversized_t-shirt_men_women_male.csv', 'w', newline='', encoding='utf-8') as csvfile:
...
with open('../urls_csv/urls_oversized_t-shirt_men_women_male.csv', 'r', newline='', encoding='utf-8') as csvfile:
    ...
    for row in reader:
        ...
        with open('../done_csv/groovee_oversized_t-shirt_men_women_male.csv', 'a', newline='', encoding='utf-8') as csvfile:
            writer = csv.writer(csvfile)
