...
with open('../urls_csv/urls_jackets.csv', 'r', newline='', encoding='utf-8') as csvfile:
    ...
    for row in reader:
        ...
        with open('../done_csv/groovee_jackets.csv', 'w', newline='', encoding='utf-8') as csvfile:
            writer = csv.writer(csvfile)
            writer.writerow(['Product ID', 'Brand', 'Category', 'Solid By', 'Product Detail', 'Title', 'Price', 'Sizes',
                             'Description', 'Photo URLs', 'URL_Product'])
        ...
        with open('../urls_csv/urls_jackets.csv', 'r', newline='', encoding='utf-8') as csvfile:
            ...
            for row in reader:
                ...
                with open('../done_csv/groovee_jackets.csv', 'a', newline='', encoding='utf-8') as csvfile:
                    writer = csv.writer(csvfile)
                    writer.writerow(
                        [product_id, brand, category, sub_category, product_detail, title, price, sizes, description,
                         ', '.join(best_photo_urls), url])
