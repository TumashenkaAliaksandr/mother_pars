...
with open('../done_csv/hoodies_sweatshirts.csv', 'w', newline='', encoding='utf-8') as csvfile:
...
with open('../urls_csv/urls_hoodies_sweatshirts.csv', 'r', newline='', encoding='utf-8') as csvfile:
    ...
    for row in reader:
        ...
        with open('../done_csv/hoodies_sweatshirts.csv', 'a', newline='', encoding='utf-8') as csvfile:
            writer = csv.writer(csvfile)
