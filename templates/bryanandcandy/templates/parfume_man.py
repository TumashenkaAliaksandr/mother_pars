...
input_file = '../urls_csv/mens-perfume_links.csv'
output_file = '../done_csv/mens-perfume.csv'
...
print('Информация успешно записана в mens-perfume.csv')
