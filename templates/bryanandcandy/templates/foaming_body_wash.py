...
input_file = '../urls_csv/foaming_body_wash_links.csv'
output_file = '../done_csv/foaming_body_wash.csv'
...
print('Информация успешно записана в foaming_body_wash.csv')
