...
input_file = '../urls_csv/body_mist_spray_for_women_links.csv'
output_file = '../done_csv/body-mist-spray-for-women.csv'
...
print('Информация успешно записана в body-mist-spray-for-women.csv')
