...
# Путь к файлу CSV
csv_file_path = "../../done_csv/back_flow_incense_cones.csv"
...
with open('../../urls_csv/urls_back_flow_incense_cones.csv', 'r', encoding='utf-8') as file:
