...
directory = '../done_csv'
filename = 'myatulya_hot_deals.csv'
...
urls_filename = '../urls_csv/hot_deals_links.csv'  # Укажите имя вашего файла с URL
...
order = ['ID', 'Title', 'Brand', 'Price', 'Category', 'Total Price', 'Sale Price', 'Description',
