...
base_url = "https://frenchcrown.in/collections/new-tshirts"
driver.get(base_url)
...
fieldnames = ['url']
with open('templates/../../../urls_csv/urls_new_tshirts.csv', 'w', newline='', encoding='utf-8') as file:
    writer = csv.DictWriter(file, fieldnames=fieldnames)
    writer.writeheader()
    for link in product_links:
        writer.writerow({'url': link})

print("Ссылки на товары были успешно записаны в файл 'urls_tshirts.csv'.")
...
base_url = "https://frenchcrown.in/collections/tshirts"
...
def main(base_url):
    ...
    with open('templates/../../../urls_csv/urls_tshirts.csv', 'w', newline='', encoding='utf-8') as file:
