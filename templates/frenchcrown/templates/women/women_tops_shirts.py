...
def get_data(url):
    ...
    title = soup.find("h1", class_="ProductMeta__Title").text.strip()
    print('Title: ', title)

    category = "Women's Tops"
    sub_category = "Women's Tops Shirts"
...
def main():
    ...
    with open('templates/../../../urls_csv/urls_women_tops_shirts.csv', 'r', encoding='utf-8') as file:
