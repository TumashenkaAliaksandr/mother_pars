...
filename = 'all_women_products.csv'
...
def get_data(url):
    ...
    category = "Women's All Products"
    sub_category = "Women's All Products"
...
def main():
    ...
    with open('templates/../../../urls_csv/urls_all_women_products.csv', 'r', encoding='utf-8') as file:
