...
filename = 'wedding_engagement.csv'
...
def get_data(url):
    ...
    category = "Men’s"
    sub_category = 'Men’s Wedding / Engagement Collections'
...
def main():
    ...
    with open('templates/../../../urls_csv/urls_wedding_engagement.csv', 'r', encoding='utf-8') as file:
