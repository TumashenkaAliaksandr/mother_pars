...
FILENAME = 'urls_folkbazar_incense_sticks_burner_powder.csv'
...
url = "https://folkbazar.com/en-us/collections/incense-sticks-burner-powder"
...
if response.status_code == 200:
    ...
    for link_element in link_elements:
        ...
        if link and '/collections/incense-sticks-burner-powder/products/':
            ...
            if page_link is not None:
                ...
                if page_response.status_code == 200:
                    ...
                    for page_link_element in page_link_elements:
                        ...
                        if page_link and ('/collections/incense-sticks-burner-powder/products/'):
