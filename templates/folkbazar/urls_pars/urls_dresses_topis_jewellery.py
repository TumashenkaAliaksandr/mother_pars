...
FILENAME = 'urls_folkbazar_dresses_topis_jewellery.csv'
...
base_url = "https://folkbazar.com/en-us/collections/dresses-topis-jewellery?page="
...
if response.status_code == 200:
    ...
    for link_element in link_elements:
        ...
        if link and '/collections/dresses-topis-jewellery/products/' in link and 'incense' not in link:
    ...
    if pagination is not None:
        ...
        for page in pages:
            ...
            if page_link and '/collections/dresses-topis-jewellery?page=' in page_link:
                ...
                if page_response.status_code == 200:
                    ...
                    for page_link_element in page_link_elements:
                        ...
                        if page_link and '/collections/dresses-topis-jewellery/products/' in page_link and 'incense' not in page_link:
