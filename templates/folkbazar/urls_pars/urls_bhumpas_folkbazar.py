...
FILENAME = 'urls_folkbazar_bhumpas.csv'
...
url = "https://folkbazar.com/en-us/collections/bhumpas"
...
if response.status_code == 200:
    ...
    for link_element in link_elements:
        ...
        if link and '/collections/bhumpas/products/' in link:
            ...
            if page_link is not None:
                ...
                if page_response.status_code == 200:
                    ...
                    for page_link_element in page_link_elements:
                        ...
                        if page_link and '/collections/bhumpas/products/' in page_link:
