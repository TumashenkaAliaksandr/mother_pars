...
FILENAME = 'urls_folkbazar_radung_gyaling.csv'
...
url = "https://folkbazar.com/en-us/collections/radung-gyaling"
...
if response.status_code == 200:
    ...
    for link_element in link_elements:
        ...
        if link and '/collections/radung-gyaling/products/' in link and 'incense' not in link:
            ...
            if page_link is not None:
                ...
                if page_response.status_code == 200:
                    ...
                    for page_link_element in page_link_elements:
                        ...
                        if page_link and ('/collections/radung-gyaling/products/' in page_link and 'incense' not in page_link):
