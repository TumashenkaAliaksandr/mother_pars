...
FILENAME = 'urls_folkbazar_hemp_bags.csv'
...
base_url = "https://folkbazar.com/en-us/collections/hemp-bags?page="
...
if response.status_code == 200:
    ...
    for link_element in link_elements:
        ...
        if link and '/collections/hemp-bags/products/' in link and 'incense' not in link:
    ...
    if pagination is not None:
        ...
        for page in pages:
            ...
            if page_link and '/collections/hemp-bags?page=' in page_link:
                ...
                if page_response.status_code == 200:
                    ...
                    for page_link_element in page_link_elements:
                        ...
                        if page_link and '/collections/hemp-bags/products/' in page_link and 'incense' not in page_link:
