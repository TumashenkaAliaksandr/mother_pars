...
filename = 'tibetan_buddhist_instruments.csv'
...
def get_data(url):
    ...
    category = 'Tibetan Buddhist Instruments & Covers'
...
def main():
    ...
    with open('templates/../urls_csv/urls_folkbazar_tibetan_buddhist_instruments.csv', 'r', encoding='utf-8') as file:
