...
filename = 'womens_classic_crew_neck_t_shirt.csv'
...
def main():
    ...
    with open('templates/../../../../urls_csv/womens_classic_crew_neck_t_shirt.csv', 'r', encoding='utf-8') as file:
