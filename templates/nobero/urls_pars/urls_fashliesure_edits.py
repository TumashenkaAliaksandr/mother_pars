...
base_url = "https://nobero.com/collections/fashliesure-edits"
driver.get(base_url)
...
fieldnames = ['url']
with open('templates/../../urls_csv/fashliesure_edits.csv', 'w', newline='', encoding='utf-8') as file:
    writer = csv.DictWriter(file, fieldnames=fieldnames)
    writer.writeheader()
    for link in product_links:
        writer.writerow({'url': link})

print("Ссылки на товары были успешно записаны в файл 'cozy-lounge-1.csv'.")
