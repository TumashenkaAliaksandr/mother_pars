...
base_url = "https://nobero.com/collections/everyday-bottomwear-women"
driver.get(base_url)
...
fieldnames = ['url']
with open('templates/../../urls_csv/everyday_bottomwear_women.csv', 'w', newline='', encoding='utf-8') as file:
    writer = csv.DictWriter(file, fieldnames=fieldnames)
    writer.writeheader()
    for link in product_links:
        writer.writerow({'url': link})

print("Ссылки на товары были успешно записаны в файл 'womens-coord-sets.csv'.")
