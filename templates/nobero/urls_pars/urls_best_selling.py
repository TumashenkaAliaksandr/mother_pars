...
base_url = "https://nobero.com/collections/best-selling-co-ord-sets"
driver.get(base_url)
...
fieldnames = ['url']
with open('templates/../../urls_csv/best_selling_co_ord_sets.csv', 'w', newline='', encoding='utf-8') as file:
    writer = csv.DictWriter(file, fieldnames=fieldnames)
    writer.writeheader()
    for link in product_links:
        writer.writerow({'url': link})

print("Ссылки на товары были успешно записаны в файл 'pick_printed_t_shirts.csv'.")
