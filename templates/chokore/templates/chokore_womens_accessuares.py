...
with open('chokore_product_womens_data.csv', 'w', newline='', encoding='utf-8') as csvfile:
...
with open('../product_links_women.csv', 'r', newline='', encoding='utf-8') as csvfile:
    ...
    for row in reader:
        ...
        with open('chokore_product_womens_data.csv', 'a', newline='', encoding='utf-8') as csvfile:
            writer = csv.writer(csvfile)
            writer.writerow([
