...
with open('chokore_product_gift_sets_data.csv', 'w', newline='', encoding='utf-8') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(['Product ID', 'Brend', 'Title', 'Price', 'Description', 'Details', 'Max Image URL', 'Category', 'URL'])
...
with open('../product_gift_sets.csv', 'r', newline='', encoding='utf-8') as csvfile:
    ...
    for row in reader:
        ...
        with open('chokore_product_gift_sets_data.csv', 'a', newline='', encoding='utf-8') as csvfile:
            writer = csv.writer(csvfile)
            writer.writerow([
